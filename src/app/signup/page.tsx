...
import { signUp, confirmSignUp, resendSignUpCode, signInWithRedirect, fetchAuthSession } from "aws-amplify/auth";
...
export default function SignupPage() {
  ...
  return (
    <div className="relative flex items-center justify-center min-h-screen overflow-hidden bg-background transition-colors duration-500">
      ...
      <div className="relative z-10 w-full max-w-md sm:max-w-lg lg:max-w-xl glass-vivid rounded-[2.5rem] p-8 shadow-2xl">
          ...
          <>
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full bg-background/50 border border-slate-200 dark:border-white/10 py-4 rounded-xl hover:bg-background/80 transition-all flex items-center justify-center gap-3 shadow-lg text-foreground font-medium"
              >
