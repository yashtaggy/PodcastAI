    ...
    <Sidebar className="border-r border-sidebar-border bg-sidebar-background">
      <SidebarHeader className="p-6">
        <Link href="/dashboard" className="flex items-center gap-3 group">
          ...
          <span className="text-2xl font-black tracking-tighter text-sidebar-foreground">PodCast AI</span>
        </Link>
      </SidebarHeader>
            ...
            <SidebarMenuItem key={item.href}>
              <Link href={item.href}>
                <SidebarMenuButton
                  ...
                  className="rounded-xl h-12 px-4 font-bold text-sidebar-foreground/70 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-all data-[active=true]:bg-primary data-[active=true]:text-primary-foreground data-[active=true]:shadow-lg active:scale-95"
                >
